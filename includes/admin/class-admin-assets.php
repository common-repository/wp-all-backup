...
class WPALLAdminAssets {
	...
	public function admin_scripts() {
         if (isset($_GET['page'])) {
            ...
            if ($_GET['page'] == "wpallbackup-listing" || $_GET['page'] == "wpallbackup-destination" || $_GET['page'] == "wpallbackup-help" || $_GET['page'] == "wpallbackup-pro" || $_GET['page'] == "wpallbackup-settings") {  
