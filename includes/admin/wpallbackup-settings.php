     ...
     <br>Select Individual file and directory filters (select  file and directory to exclude files from backup).</div>
                        ...
                        <script>
                            ...
                            function excludetableall(){
                              ...
                              var checked = ''
                              if($('#wp_db_exclude_table_all').prop("checked") == true){
                                checked = 'checked';
                              }
                               $('.wp_db_exclude_table').each(function() {
                                ...
                                <div class="panel-body">
                                    <table class="table table-condensed">
                                        <tr class="success">
                                            ...
                                            <th>Records</th>
                                            <th>
                                              <input type="checkbox" value="" class="form-control" onclick="excludetableall()" name="wp_db_exclude_table_all" id="wp_db_exclude_table_all">
                                              Exclude Table
                                            </th>
...
foreach ($tablesstatus as $tablestatus) {
    ...
    echo '<td> <input type="checkbox" ' . $checked . ' value="' . $tablestatus->Name . '" class="form-control wp_db_exclude_table" name="wp_db_exclude_table[' . $tablestatus->Name . ']"></td>';
...
<div role="alert" class="alert alert-success"><h4>Get Flat 35% off on <a target="_blank" href="https://www.wpseeds.com/product/wp-all-backup/">Pro WP All Backup Plus Plugin.</a> Use Coupon code 'WPALLBACKUP35'</h4></div>                                                    </div>
                                                    </div>
